...
public class DepartmentController implements Initializable {
    ...
    @FXML
    private AnchorPane departmentframe;
    ...
    public void addEvent(ActionEvent e){
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Department/adddepartment.fxml"));
    ...
    public void updateEvent(ActionEvent e){
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Department/updatedepartment.fxml"));
            HomepageController.setforeignNode(root);
        } catch (IOException ex) {
            Logger.getLogger(CourseController.class.getName()).log(Level.SEVERE, null, ex);
        }   
    ...
    public void viewEvent(ActionEvent e){
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Department/viewdepartment.fxml"));
            HomepageController.setforeignNode(root);
        } catch (IOException ex) {
            Logger.getLogger(CourseController.class.getName()).log(Level.SEVERE, null, ex);
        }
