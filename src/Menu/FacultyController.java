...
public class FacultyController implements Initializable {
    ...
    public void addEvent(ActionEvent e){
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Faculty/addfaculty.fxml"));
    ...
    public void updateEvent(ActionEvent e){
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Faculty/updatefaculty.fxml"));
            HomepageController.setforeignNode(root);
        } catch (IOException ex) {
            Logger.getLogger(CourseController.class.getName()).log(Level.SEVERE, null, ex);
        }          
    ...
    public void viewEvent(ActionEvent e){
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Faculty/viewfaculty.fxml"));
            HomepageController.setforeignNode(root);
        } catch (IOException ex) {
            Logger.getLogger(CourseController.class.getName()).log(Level.SEVERE, null, ex);
        }
