...
public class getstudentdata {
    private final StringProperty id,name,fathersname,dob,gender,bloodgroup,department,address,city,state,zipcode,phone,email,doj;
    
    public getstudentdata(String id,String name, String fathersname, String dob,String gender, String bloodgroup, String department,String address, String city, String state,String zipcode, String phone,String email,String doj)
    {
